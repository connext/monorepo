...
yarn workspace @connext/nxtp-subgraph create:spoke_devnet_optimism --node http://localhost:9020/
yarn workspace @connext/nxtp-subgraph deploy:spoke_devnet_optimism --node http://localhost:9020/ -l v0.0.1
...
yarn workspace @connext/nxtp-subgraph create:spoke_devnet_gnosis --node http://localhost:7020/
yarn workspace @connext/nxtp-subgraph deploy:spoke_devnet_gnosis --node http://localhost:7020/ -l v0.0.1
