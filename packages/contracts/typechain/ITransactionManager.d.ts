...
interface ITransactionManagerInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "getAmountFromShares", values: [string, BigNumberish]): string;
  ...
  decodeFunctionResult(functionFragment: "getAmountFromShares", data: BytesLike): Result;
...
export class ITransactionManager extends BaseContract {
  ...
  callStatic: {
    ...
    getAmountFromShares(assetId: string, shares: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
