...
interface IConditionInterpreterInterface extends ethers.utils.Interface {
  functions: {
...
export class IConditionInterpreter extends BaseContract {
  ...
  interface: IConditionInterpreterInterface;
