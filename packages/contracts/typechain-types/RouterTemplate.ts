...
export interface RouterTemplateInterface extends utils.Interface {
  contractName: "RouterTemplate";
  functions: {
...
export type TypeAReceivedEvent = TypedEvent<[BigNumber], { number: BigNumber }>;

export type TypeAReceivedEventFilter = TypedEventFilter<TypeAReceivedEvent>;

export interface RouterTemplate extends BaseContract {
  contractName: "RouterTemplate";
  ...
  filters: {
    ...
    "TypeAReceived(uint256)"(number?: null): TypeAReceivedEventFilter;
    TypeAReceived(number?: null): TypeAReceivedEventFilter;
  };
