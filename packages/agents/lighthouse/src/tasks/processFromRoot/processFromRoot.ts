import { ChainReader, contractDeployments } from "@connext/txservice";
...
export const makeProcessFromRoot = async (config: LighthouseConfig, chainData: Map<string, ChainData>) => {
