...
describe("Operations:Auctions", () => {
  ...
  describe("#executeAuction", () => {
    ...
    it("should pick up the auction rounds which has enough number of bids", async () => {
      ...
      sendBidsToRelayerStub.resolves(taskId);
      ...
      expect(sendBidsToRelayerStub.getCall(0).args[0]).to.be.eq(1);
      expect(sendBidsToRelayerStub.getCall(0).args[1]).to.be.deep.eq([
        {
          routerVersion: "0.0.0",
          transferId: transferId,
          origin: "1111",
    ...
    it("should pick up a round-2 auction if a round-1 auction doesn't exist", async () => {
      ...
      expect(sendBidsToRelayerStub.getCall(0).args[0]).to.be.eq(2);
      expect(sendBidsToRelayerStub.getCall(0).args[1]).to.be.deep.eq([
        {
          routerVersion: "0.0.0",
          transferId: transferId,
