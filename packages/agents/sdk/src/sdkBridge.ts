 ...
 */
export class NxtpSdkBridge extends NxtpSdkBase {
  private static _instance: NxtpSdkBridge;
  ...
  static async create(
    ...
    return this._instance || (this._instance = new NxtpSdkBridge(nxtpConfig, logger, chainData));
  }
