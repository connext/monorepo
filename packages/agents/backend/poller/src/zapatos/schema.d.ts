...
declare module 'zapatos/schema' {
  ...
  export type Table = asset_balances.Table | assets.Table | routers.Table | routers_with_balances.Table | schema_migrations.Table | transfers.Table;
  export type Selectable = asset_balances.Selectable | assets.Selectable | routers.Selectable | routers_with_balances.Selectable | schema_migrations.Selectable | transfers.Selectable;
  export type JSONSelectable = asset_balances.JSONSelectable | assets.JSONSelectable | routers.JSONSelectable | routers_with_balances.JSONSelectable | schema_migrations.JSONSelectable | transfers.JSONSelectable;
  export type Whereable = asset_balances.Whereable | assets.Whereable | routers.Whereable | routers_with_balances.Whereable | schema_migrations.Whereable | transfers.Whereable;
  export type Insertable = asset_balances.Insertable | assets.Insertable | routers.Insertable | routers_with_balances.Insertable | schema_migrations.Insertable | transfers.Insertable;
  export type Updatable = asset_balances.Updatable | assets.Updatable | routers.Updatable | routers_with_balances.Updatable | schema_migrations.Updatable | transfers.Updatable;
  export type UniqueIndex = asset_balances.UniqueIndex | assets.UniqueIndex | routers.UniqueIndex | routers_with_balances.UniqueIndex | schema_migrations.UniqueIndex | transfers.UniqueIndex;
  export type Column = asset_balances.Column | assets.Column | routers.Column | routers_with_balances.Column | schema_migrations.Column | transfers.Column;
  ...
  export type AllTablesAndViews = [asset_balances.Table, assets.Table, routers.Table, routers_with_balances.Table, schema_migrations.Table, transfers.Table];
