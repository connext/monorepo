...
export function handleTransactionPrepared(event: TransactionPrepared): void {
  ...
  // TransactionData
  transaction.receivingChainCondition = event.params.txData.receivingChainCondition;
  transaction.sendingChainCondition = event.params.txData.sendingChainCondition;
  ...
  transaction.encodedConditionData = event.params.txData.encodedConditionData;
...
export function handleTransactionFulfilled(event: TransactionFulfilled): void {
  ...
  transaction!.fulfillUnlockData = event.params.args.unlockData;
...
export function handleTransactionCancelled(event: TransactionCancelled): void {
  ...
  transaction!.cancelUnlockData = event.params.args.unlockData;
