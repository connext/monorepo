...
export const StateCommitmentChainAbi = [
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_sequencerPublishWindow", type: "uint256" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "_chainId", type: "uint256" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes32[]", name: "_batch", type: "bytes32[]" },
      { internalType: "uint256", name: "_shouldStartAtElement", type: "uint256" },
      { internalType: "string", name: "proposer", type: "string" },
    ],
  ...
  },
  {
    inputs: [],
    name: "batches",
    outputs: [{ internalType: "contract IChainStorageContainer", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: "uint256", name: "_lastSequencerTimestamp", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
