...
describe("Connext", () => {
  ...
  before("create fixture loader", async () => {
    ...
    await originRelayerFeeRouter.connect(admin).setConnext(originTm.address);
    await originRelayerFeeRouter
      .connect(admin)
      .enrollRemoteRouter(destinationDomain, addressToBytes32(destinationRelayerFeeRouter.address));

    await destinationRelayerFeeRouter.connect(admin).setConnext(destinationTm.address);
