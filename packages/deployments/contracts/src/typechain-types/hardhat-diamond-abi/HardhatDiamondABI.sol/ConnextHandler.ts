...
export type ExecuteArgsStructOutput = [CallParamsStructOutput, string[], string[], string, string] & {
...
export interface ConnextHandlerInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "DUST_AMOUNT", values?: undefined): string;
  ...
  encodeFunctionData(
    ...
    values: [CallParamsStruct, PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>],
  ): string;
  ...
  decodeFunctionResult(functionFragment: "DUST_AMOUNT", data: BytesLike): Result;
...
export type SendEvent = TypedEvent<[string, string, number, string, BigNumber, boolean], SendEventObject>;
...
export type XCalledEvent = TypedEvent<[string, BigNumber, string, CallParamsStructOutput, string], XCalledEventObject>;
...
export interface ConnextHandler extends BaseContract {
  ...
  filters: {
    ...
    RelayerFeeVaultUpdated(oldRouter?: null, newRouter?: null, caller?: null): RelayerFeeVaultUpdatedEventFilter;
