...
export type ExecuteArgsStructOutput = [TransferIdInformationStructOutput, string[], string[], string, string] & {
...
export interface ConnextInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [TransferIdInformationStruct, PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>],
  ): string;
...
export type XCalledEvent = TypedEvent<
  [string, BigNumber, string, TransferIdInformationStructOutput, string, BigNumber],
  XCalledEventObject
>;
