...
import type { RootManager, RootManagerInterface } from "../../../../contracts/core/messaging/RootManager";
...
export class RootManager__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<RootManager> {
