...
type WormholeHubConnectorConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: WormholeHubConnectorConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class WormholeHubConnector__factory extends ContractFactory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): WormholeHubConnector {
    return new Contract(address, _abi, signerOrProvider) as WormholeHubConnector;
  }
}
