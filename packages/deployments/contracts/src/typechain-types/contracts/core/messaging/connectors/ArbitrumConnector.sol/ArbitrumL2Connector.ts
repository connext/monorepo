...
export interface ArbitrumL2ConnectorInterface extends utils.Interface {
  functions: {
...
export interface ArbitrumL2Connector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArbitrumL2ConnectorInterface;
