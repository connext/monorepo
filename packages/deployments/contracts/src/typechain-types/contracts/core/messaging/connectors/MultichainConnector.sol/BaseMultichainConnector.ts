...
export interface BaseMultichainConnectorInterface extends utils.Interface {
  functions: {
...
export interface BaseMultichainConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseMultichainConnectorInterface;
