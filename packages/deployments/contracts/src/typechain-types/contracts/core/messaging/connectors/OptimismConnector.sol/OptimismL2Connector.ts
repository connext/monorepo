...
export interface OptimismL2ConnectorInterface extends utils.Interface {
  functions: {
...
export interface OptimismL2Connector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismL2ConnectorInterface;
