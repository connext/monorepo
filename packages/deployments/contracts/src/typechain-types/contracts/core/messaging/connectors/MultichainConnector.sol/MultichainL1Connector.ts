...
export interface MultichainL1ConnectorInterface extends utils.Interface {
  functions: {
...
export interface MultichainL1Connector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultichainL1ConnectorInterface;
