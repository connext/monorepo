...
export interface BaseOptimismConnectorInterface extends utils.Interface {
  functions: {
  ...
  decodeFunctionResult(functionFragment: "receiveGas", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "receiveRoot",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "RootUpdateReceived(address,bytes,address)": EventFragment;
    "RootUpdateSent(bytes,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "RootUpdateReceived"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RootUpdateSent"): EventFragment;
...
export interface RootUpdateReceivedEventObject {
  from: string;
  data: string;
  caller: string;
}
export type RootUpdateReceivedEvent = TypedEvent<
  [string, string, string],
  RootUpdateReceivedEventObject
>;

export type RootUpdateReceivedEventFilter =
  TypedEventFilter<RootUpdateReceivedEvent>;

export interface RootUpdateSentEventObject {
  data: string;
  caller: string;
}
export type RootUpdateSentEvent = TypedEvent<
  [string, string],
  RootUpdateSentEventObject
>;

export type RootUpdateSentEventFilter = TypedEventFilter<RootUpdateSentEvent>;
...
export interface BaseOptimismConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseOptimismConnectorInterface;
  ...
  functions: {
    ...
    receiveGas(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "RootUpdateReceived(address,bytes,address)"(
      from?: null,
      data?: null,
      caller?: null
    ): RootUpdateReceivedEventFilter;
    RootUpdateReceived(
      from?: null,
      data?: null,
      caller?: null
    ...
    "RootUpdateSent(bytes,address)"(
      data?: null,
      caller?: null
    ): RootUpdateSentEventFilter;
    RootUpdateSent(data?: null, caller?: null): RootUpdateSentEventFilter;
  ...
  populateTransaction: {
    ...
    receiveGas(overrides?: CallOverrides): Promise<PopulatedTransaction>;
