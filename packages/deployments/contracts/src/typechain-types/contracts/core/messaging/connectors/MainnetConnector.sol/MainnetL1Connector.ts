...
export interface MainnetL1ConnectorInterface extends utils.Interface {
  functions: {
...
export interface MainnetL1Connector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MainnetL1ConnectorInterface;
