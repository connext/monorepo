...
export interface GnosisL2ConnectorInterface extends utils.Interface {
  functions: {
...
export interface GnosisL2Connector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GnosisL2ConnectorInterface;
