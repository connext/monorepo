...
export interface PolygonL2ConnectorInterface extends utils.Interface {
  functions: {
...
export type MessageSent_bytes_Event = TypedEvent<
  [string],
  MessageSent_bytes_EventObject
>;
...
export interface PolygonL2Connector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PolygonL2ConnectorInterface;
