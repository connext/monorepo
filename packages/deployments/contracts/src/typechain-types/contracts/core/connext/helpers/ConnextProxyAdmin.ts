...
export interface ConnextProxyAdminInterface extends utils.Interface {
  functions: {
...
export interface ConnextProxyAdmin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnextProxyAdminInterface;
