...
export interface RelayerProxyHubInterface extends utils.Interface {
  functions: {
    ...
    "receiveSpokeRoot(bytes,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "receiveSpokeRoot",
  ...
  events: {
    ...
    "HubConnectorChanged(address,address)": EventFragment;
...
export interface RelayerProxyHub extends BaseContract {
  ...
  functions: {
    ...
    hubConnector(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "HubConnectorChanged(address,address)"(
      hubConnector?: null,
  ...
  estimateGas: {
    ...
    hubConnector(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    hubConnector(overrides?: CallOverrides): Promise<PopulatedTransaction>;
