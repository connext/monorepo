...
export interface OptimismV0HubConnectorInterface extends utils.Interface {
  functions: {
...
export interface OptimismV0HubConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismV0HubConnectorInterface;
