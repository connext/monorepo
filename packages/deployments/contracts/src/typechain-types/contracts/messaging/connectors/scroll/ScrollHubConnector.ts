...
export interface ScrollHubConnectorInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "L1_SCROLL_MESSENGER",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ScrollHubConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ScrollHubConnectorInterface;
