...
export interface MantleSpokeConnectorInterface extends utils.Interface {
  functions: {
...
export interface MantleSpokeConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MantleSpokeConnectorInterface;
