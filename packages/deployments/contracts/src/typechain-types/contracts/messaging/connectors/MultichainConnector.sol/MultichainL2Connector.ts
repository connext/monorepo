...
export interface MultichainL2ConnectorInterface extends utils.Interface {
  functions: {
...
export interface MultichainL2Connector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultichainL2ConnectorInterface;
