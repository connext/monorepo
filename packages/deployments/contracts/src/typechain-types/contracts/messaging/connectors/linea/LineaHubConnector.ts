...
export interface LineaHubConnectorInterface extends utils.Interface {
  functions: {
    ...
    "claimMessage(bytes,uint256)": FunctionFragment;
...
export interface LineaHubConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LineaHubConnectorInterface;
