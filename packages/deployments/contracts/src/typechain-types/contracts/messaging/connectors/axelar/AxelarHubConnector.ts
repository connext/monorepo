...
export interface AxelarHubConnectorInterface extends utils.Interface {
  functions: {
...
export interface AxelarHubConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AxelarHubConnectorInterface;
