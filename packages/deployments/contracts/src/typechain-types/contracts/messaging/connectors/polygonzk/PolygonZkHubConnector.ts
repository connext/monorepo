...
export interface PolygonZkHubConnectorInterface extends utils.Interface {
  functions: {
...
export interface PolygonZkHubConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PolygonZkHubConnectorInterface;
