...
export interface ArbitrumL1ConnectorInterface extends utils.Interface {
  functions: {
...
export interface ArbitrumL1Connector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArbitrumL1ConnectorInterface;
