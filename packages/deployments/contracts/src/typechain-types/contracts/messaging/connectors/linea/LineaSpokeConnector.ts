...
export interface LineaSpokeConnectorInterface extends utils.Interface {
  functions: {
...
export interface LineaSpokeConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LineaSpokeConnectorInterface;
