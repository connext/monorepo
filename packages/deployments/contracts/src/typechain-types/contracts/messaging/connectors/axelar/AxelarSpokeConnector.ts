...
export interface AxelarSpokeConnectorInterface extends utils.Interface {
  functions: {
...
export interface AxelarSpokeConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AxelarSpokeConnectorInterface;
