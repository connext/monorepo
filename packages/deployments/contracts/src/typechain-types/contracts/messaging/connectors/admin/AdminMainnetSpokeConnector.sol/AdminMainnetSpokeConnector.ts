...
export interface AdminMainnetSpokeConnectorInterface extends utils.Interface {
  functions: {
...
export interface AdminMainnetSpokeConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdminMainnetSpokeConnectorInterface;
