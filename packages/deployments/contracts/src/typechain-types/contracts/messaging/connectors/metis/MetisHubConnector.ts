...
export interface MetisHubConnectorInterface extends utils.Interface {
  functions: {
...
export interface MetisHubConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MetisHubConnectorInterface;
