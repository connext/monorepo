...
export interface AdminSpokeConnectorInterface extends utils.Interface {
  functions: {
    ...
    "receiveHubAggregateRoot(bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "receiveHubAggregateRoot",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
...
export interface AdminSpokeConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdminSpokeConnectorInterface;
