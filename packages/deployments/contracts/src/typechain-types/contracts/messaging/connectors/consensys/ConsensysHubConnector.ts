...
export interface ConsensysHubConnectorInterface extends utils.Interface {
  functions: {
...
export interface ConsensysHubConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConsensysHubConnectorInterface;
