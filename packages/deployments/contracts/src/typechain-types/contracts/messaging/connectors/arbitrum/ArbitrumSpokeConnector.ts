...
export interface ArbitrumSpokeConnectorInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "aliasedSender", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "aliasedSender", data: BytesLike): Result;
...
export type AliasedSenderUpdatedEvent = TypedEvent<[string, string], AliasedSenderUpdatedEventObject>;

export type AliasedSenderUpdatedEventFilter = TypedEventFilter<AliasedSenderUpdatedEvent>;
...
export interface ArbitrumSpokeConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArbitrumSpokeConnectorInterface;
  ...
  filters: {
    ...
    "AliasedSenderUpdated(address,address)"(previous?: null, current?: null): AliasedSenderUpdatedEventFilter;
    AliasedSenderUpdated(previous?: null, current?: null): AliasedSenderUpdatedEventFilter;
