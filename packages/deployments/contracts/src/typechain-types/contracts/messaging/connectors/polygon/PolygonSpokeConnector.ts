...
export type MessageSent_bytes_address_Event = TypedEvent<[string, string], MessageSent_bytes_address_EventObject>;

export type MessageSent_bytes_address_EventFilter = TypedEventFilter<MessageSent_bytes_address_Event>;
...
export interface PolygonSpokeConnector extends BaseContract {
  ...
  filters: {
    ...
    "MessageSent(bytes,address)"(data?: null, caller?: null): MessageSent_bytes_address_EventFilter;
