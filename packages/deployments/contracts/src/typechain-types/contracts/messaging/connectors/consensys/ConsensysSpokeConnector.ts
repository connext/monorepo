...
export interface ConsensysSpokeConnectorInterface extends utils.Interface {
  functions: {
...
export interface ConsensysSpokeConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConsensysSpokeConnectorInterface;
