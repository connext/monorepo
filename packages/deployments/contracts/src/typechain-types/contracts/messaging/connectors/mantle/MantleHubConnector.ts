...
export interface MantleHubConnectorInterface extends utils.Interface {
  functions: {
    ...
    "processMessageFromRoot(address,address,bytes,uint256,(bytes32,(uint256,bytes32,uint256,uint256,bytes,bytes),(uint256,bytes32[]),bytes,bytes))": FunctionFragment;
...
export interface MantleHubConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MantleHubConnectorInterface;
