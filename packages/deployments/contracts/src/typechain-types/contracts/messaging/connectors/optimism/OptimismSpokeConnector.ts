...
export interface OptimismSpokeConnectorInterface extends utils.Interface {
  functions: {
...
export interface OptimismSpokeConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismSpokeConnectorInterface;
