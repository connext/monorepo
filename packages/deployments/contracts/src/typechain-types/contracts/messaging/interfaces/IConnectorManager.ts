...
export interface IConnectorManagerInterface extends utils.Interface {
  functions: {
...
export interface IConnectorManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IConnectorManagerInterface;
