...
export interface VerifierWithDeserializeInterface extends utils.Interface {
  functions: {
...
export interface VerifierWithDeserialize extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VerifierWithDeserializeInterface;
