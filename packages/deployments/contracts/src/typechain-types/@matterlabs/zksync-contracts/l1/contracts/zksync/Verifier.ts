...
export interface Verifier extends BaseContract {
  ...
  functions: {
    verifyAggregatedBlockProof(
      _recursiveInput: PromiseOrValue<BigNumberish>[],
      _proof: PromiseOrValue<BigNumberish>[],
      _vkIndexes: PromiseOrValue<BigNumberish>[],
      _individual_vks_inputs: PromiseOrValue<BigNumberish>[],
      _subproofs_limbs: PromiseOrValue<BigNumberish>[],
