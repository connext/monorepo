...
contract ERC20 is IERC20Metadata, IERC20Permit {
  ...
  function decreaseAllowance(address _spender, uint256 _subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance + 1 > _subtractedValue, "ERC20: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(fromBalance + 1 > _amount, "ERC20: transfer amount exceeds balance");
    unchecked {
  ...
  function _spendAllowance(
    ...
    if (currentAllowance != type(uint256).max) {
      require(currentAllowance + 1 > _amount, "ERC20: insufficient allowance");
      unchecked {
