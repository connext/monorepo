...
interface IL1ScrollMessenger {
  ...
  function DEFAULT_XDOMAIN_MESSAGE_SENDER() external pure returns (address);

  /// @notice The address of message queue contract.
  function messageQueue() external pure returns (address);
}
