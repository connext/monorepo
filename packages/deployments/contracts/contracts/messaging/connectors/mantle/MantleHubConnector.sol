...
import {IStateCommitmentChain, L2MessageInclusionProof} from "../../interfaces/ambs/mantle/IStateCommitmentChain.sol";
...
import {PredeployAddresses} from "../optimism-v0/lib/PredeployAddresses.sol";
import {OVMCodec} from "../optimism-v0/lib/OVMCodec.sol";
import {SecureMerkleTrie} from "../optimism-v0/lib/SecureMerkleTrie.sol";

import {BaseOptimismV0} from "../optimism-v0/BaseOptimismV0.sol";

/**
 * @title MantleHubConnector
 * @notice Mantle is a pre-bedrock optimism fork, with a modified header structure. This alters the `processMessageFromRoot` interface.
 * @dev MantleHubConnector uses a pre-bedrock version of the optimism contracts.
 * See the original ChainBatchHeader structure here: https://github.com/ethereum-optimism/optimism/blob/fcfcf6e7e69801e63904ec53815db01a8d45dcac/packages/contracts/contracts/libraries/codec/Lib_OVMCodec.sol#L34-L40
 */
contract MantleHubConnector is HubConnector, BaseOptimismV0 {
  // ============ Libraries ============
