...
export interface PropertyQueryInterface extends utils.Interface {
  functions: {
    ...
    "getOriginSender()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getOriginSender",
    values?: undefined
  ): string;
...
export interface PropertyQuery extends BaseContract {
  ...
  callStatic: {
    ...
    getOrigin(overrides?: CallOverrides): Promise<number>;

    getOriginSender(overrides?: CallOverrides): Promise<string>;
