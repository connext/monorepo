...
export type kovan_AssetBalance_orderBy = "id" | "amount" | "router" | "asset";
...
export type kovan_Asset_orderBy = "id" | "local" | "adoptedAsset" | "canonicalId" | "canonicalDomain" | "blockNumber";
...
export type kovan_OrderDirection = "asc" | "desc";
...
> = ResolversObject<{
  kovan_asset?: Resolver<
    Maybe<ResolversTypes["kovan_Asset"]>,
    ParentType,
    ContextType,
    RequireFields<Querykovan_assetArgs, "id" | "subgraphError">
  >;
  kovan_assets?: Resolver<
    Array<ResolversTypes["kovan_Asset"]>,
    ParentType,
    ContextType,
    RequireFields<Querykovan_assetsArgs, "skip" | "first" | "subgraphError">
  >;
  kovan_assetBalance?: Resolver<
    Maybe<ResolversTypes["kovan_AssetBalance"]>,
    ParentType,
    ContextType,
    RequireFields<Querykovan_assetBalanceArgs, "id" | "subgraphError">
  >;
  kovan_assetBalances?: Resolver<
    Array<ResolversTypes["kovan_AssetBalance"]>,
    ParentType,
    ContextType,
    RequireFields<Querykovan_assetBalancesArgs, "skip" | "first" | "subgraphError">
  >;
  kovan_router?: Resolver<
    Maybe<ResolversTypes["kovan_Router"]>,
    ParentType,
    ContextType,
    RequireFields<Querykovan_routerArgs, "id" | "subgraphError">
  >;
  kovan_routers?: Resolver<
    Array<ResolversTypes["kovan_Router"]>,
    ParentType,
    ContextType,
    RequireFields<Querykovan_routersArgs, "skip" | "first" | "subgraphError">
  >;
  kovan_transfer?: Resolver<
    Maybe<ResolversTypes["kovan_Transfer"]>,
    ParentType,
    ContextType,
    RequireFields<Querykovan_transferArgs, "id" | "subgraphError">
  >;
  kovan_transfers?: Resolver<
    Array<ResolversTypes["kovan_Transfer"]>,
    ParentType,
    ContextType,
    RequireFields<Querykovan_transfersArgs, "skip" | "first" | "subgraphError">
  >;
  ...
  >;
  rinkeby_transfer?: Resolver<
    Maybe<ResolversTypes["rinkeby_Transfer"]>,
    ParentType,
    ContextType,
    RequireFields<Queryrinkeby_transferArgs, "id" | "subgraphError">
  >;
  rinkeby_transfers?: Resolver<
    Array<ResolversTypes["rinkeby_Transfer"]>,
    ParentType,
    ContextType,
    RequireFields<Queryrinkeby_transfersArgs, "skip" | "first" | "subgraphError">
  >;
...
> = ResolversObject<{
  kovan_asset?: SubscriptionResolver<
    Maybe<ResolversTypes["kovan_Asset"]>,
    "kovan_asset",
    ParentType,
    ContextType,
    RequireFields<Subscriptionkovan_assetArgs, "id" | "subgraphError">
  >;
  kovan_assets?: SubscriptionResolver<
    Array<ResolversTypes["kovan_Asset"]>,
    "kovan_assets",
    ParentType,
    ContextType,
    RequireFields<Subscriptionkovan_assetsArgs, "skip" | "first" | "subgraphError">
  >;
  kovan_assetBalance?: SubscriptionResolver<
    Maybe<ResolversTypes["kovan_AssetBalance"]>,
    "kovan_assetBalance",
    ParentType,
    ContextType,
    RequireFields<Subscriptionkovan_assetBalanceArgs, "id" | "subgraphError">
  >;
  kovan_assetBalances?: SubscriptionResolver<
    Array<ResolversTypes["kovan_AssetBalance"]>,
    "kovan_assetBalances",
    ParentType,
    ContextType,
    RequireFields<Subscriptionkovan_assetBalancesArgs, "skip" | "first" | "subgraphError">
  >;
  kovan_router?: SubscriptionResolver<
    Maybe<ResolversTypes["kovan_Router"]>,
    "kovan_router",
    ParentType,
    ContextType,
    RequireFields<Subscriptionkovan_routerArgs, "id" | "subgraphError">
  >;
  kovan_routers?: SubscriptionResolver<
    Array<ResolversTypes["kovan_Router"]>,
    "kovan_routers",
    ParentType,
    ContextType,
    RequireFields<Subscriptionkovan_routersArgs, "skip" | "first" | "subgraphError">
  >;
  kovan_transfer?: SubscriptionResolver<
    Maybe<ResolversTypes["kovan_Transfer"]>,
    "kovan_transfer",
    ParentType,
    ContextType,
    RequireFields<Subscriptionkovan_transferArgs, "id" | "subgraphError">
  >;
  kovan_transfers?: SubscriptionResolver<
    Array<ResolversTypes["kovan_Transfer"]>,
    "kovan_transfers",
    ParentType,
    ContextType,
    RequireFields<Subscriptionkovan_transfersArgs, "skip" | "first" | "subgraphError">
  >;
  kovan__meta?: SubscriptionResolver<
    Maybe<ResolversTypes["kovan__Meta_"]>,
    "kovan__meta",
    ParentType,
    ContextType,
    Partial<Subscriptionkovan__metaArgs>
  >;
  ...
  >;
  rinkeby_transfer?: SubscriptionResolver<
    Maybe<ResolversTypes["rinkeby_Transfer"]>,
    "rinkeby_transfer",
    ParentType,
    ContextType,
    RequireFields<Subscriptionrinkeby_transferArgs, "id" | "subgraphError">
  >;
  rinkeby_transfers?: SubscriptionResolver<
    Array<ResolversTypes["rinkeby_Transfer"]>,
    "rinkeby_transfers",
    ParentType,
    ContextType,
    RequireFields<Subscriptionrinkeby_transfersArgs, "skip" | "first" | "subgraphError">
  >;
...
export type kovan_AssetResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["kovan_Asset"] = ResolversParentTypes["kovan_Asset"],
> = ResolversObject<{
...
export type kovan_AssetBalanceResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["kovan_AssetBalance"] = ResolversParentTypes["kovan_AssetBalance"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
export type kovan_RouterResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["kovan_Router"] = ResolversParentTypes["kovan_Router"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
export type kovan_TransferResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["kovan_Transfer"] = ResolversParentTypes["kovan_Transfer"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
export type kovan__Block_Resolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["kovan__Block_"] = ResolversParentTypes["kovan__Block_"],
> = ResolversObject<{
...
export type kovan__Meta_Resolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["kovan__Meta_"] = ResolversParentTypes["kovan__Meta_"],
> = ResolversObject<{
...
export type rinkeby_TransferResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["rinkeby_Transfer"] = ResolversParentTypes["rinkeby_Transfer"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  originDomain?: Resolver<Maybe<ResolversTypes["BigInt"]>, ParentType, ContextType>;
  destinationDomain?: Resolver<Maybe<ResolversTypes["BigInt"]>, ParentType, ContextType>;
...
export type QueryConnextKovanSdk = {
  /** null **/
  kovan_asset: InContextSdkMethod<
    ConnextKovanTypes.Query["kovan_asset"],
    ConnextKovanTypes.Querykovan_assetArgs,
    MeshContext
  >;
  /** null **/
  kovan_assets: InContextSdkMethod<
    ConnextKovanTypes.Query["kovan_assets"],
    ConnextKovanTypes.Querykovan_assetsArgs,
    MeshContext
  >;
  /** null **/
  kovan_assetBalance: InContextSdkMethod<
    ConnextKovanTypes.Query["kovan_assetBalance"],
    ConnextKovanTypes.Querykovan_assetBalanceArgs,
    MeshContext
  >;
  /** null **/
  kovan_assetBalances: InContextSdkMethod<
    ConnextKovanTypes.Query["kovan_assetBalances"],
    ConnextKovanTypes.Querykovan_assetBalancesArgs,
    MeshContext
  >;
  /** null **/
  kovan_router: InContextSdkMethod<
    ConnextKovanTypes.Query["kovan_router"],
    ConnextKovanTypes.Querykovan_routerArgs,
    MeshContext
  >;
  /** null **/
  kovan_routers: InContextSdkMethod<
    ConnextKovanTypes.Query["kovan_routers"],
    ConnextKovanTypes.Querykovan_routersArgs,
    MeshContext
  >;
  /** null **/
  kovan_transfer: InContextSdkMethod<
    ConnextKovanTypes.Query["kovan_transfer"],
    ConnextKovanTypes.Querykovan_transferArgs,
    MeshContext
  >;
  /** null **/
  kovan_transfers: InContextSdkMethod<
    ConnextKovanTypes.Query["kovan_transfers"],
    ConnextKovanTypes.Querykovan_transfersArgs,
    MeshContext
  >;
  /** Access to subgraph metadata **/
  kovan__meta: InContextSdkMethod<
    ConnextKovanTypes.Query["kovan__meta"],
    ConnextKovanTypes.Querykovan__metaArgs,
    MeshContext
  >;
};
...
export type SubscriptionConnextKovanSdk = {
  /** null **/
  kovan_asset: InContextSdkMethod<
    ConnextKovanTypes.Subscription["kovan_asset"],
    ConnextKovanTypes.Subscriptionkovan_assetArgs,
    MeshContext
  >;
  /** null **/
  kovan_assets: InContextSdkMethod<
    ConnextKovanTypes.Subscription["kovan_assets"],
    ConnextKovanTypes.Subscriptionkovan_assetsArgs,
    MeshContext
  >;
  /** null **/
  kovan_assetBalance: InContextSdkMethod<
    ConnextKovanTypes.Subscription["kovan_assetBalance"],
    ConnextKovanTypes.Subscriptionkovan_assetBalanceArgs,
    MeshContext
  >;
  /** null **/
  kovan_assetBalances: InContextSdkMethod<
    ConnextKovanTypes.Subscription["kovan_assetBalances"],
    ConnextKovanTypes.Subscriptionkovan_assetBalancesArgs,
    MeshContext
  >;
  /** null **/
  kovan_router: InContextSdkMethod<
    ConnextKovanTypes.Subscription["kovan_router"],
    ConnextKovanTypes.Subscriptionkovan_routerArgs,
    MeshContext
  >;
  /** null **/
  kovan_routers: InContextSdkMethod<
    ConnextKovanTypes.Subscription["kovan_routers"],
    ConnextKovanTypes.Subscriptionkovan_routersArgs,
    MeshContext
  >;
  /** null **/
  kovan_transfer: InContextSdkMethod<
    ConnextKovanTypes.Subscription["kovan_transfer"],
    ConnextKovanTypes.Subscriptionkovan_transferArgs,
    MeshContext
  >;
  /** null **/
  kovan_transfers: InContextSdkMethod<
    ConnextKovanTypes.Subscription["kovan_transfers"],
    ConnextKovanTypes.Subscriptionkovan_transfersArgs,
    MeshContext
  >;
  /** Access to subgraph metadata **/
  kovan__meta: InContextSdkMethod<
    ConnextKovanTypes.Subscription["kovan__meta"],
    ConnextKovanTypes.Subscriptionkovan__metaArgs,
    MeshContext
  >;
};
...
export type QueryConnextRinkebySdk = {
  /** null **/
  rinkeby_asset: InContextSdkMethod<
    ConnextRinkebyTypes.Query["rinkeby_asset"],
    ConnextRinkebyTypes.Queryrinkeby_assetArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_assets: InContextSdkMethod<
    ConnextRinkebyTypes.Query["rinkeby_assets"],
    ConnextRinkebyTypes.Queryrinkeby_assetsArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_assetBalance: InContextSdkMethod<
    ConnextRinkebyTypes.Query["rinkeby_assetBalance"],
    ConnextRinkebyTypes.Queryrinkeby_assetBalanceArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_assetBalances: InContextSdkMethod<
    ConnextRinkebyTypes.Query["rinkeby_assetBalances"],
    ConnextRinkebyTypes.Queryrinkeby_assetBalancesArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_router: InContextSdkMethod<
    ConnextRinkebyTypes.Query["rinkeby_router"],
    ConnextRinkebyTypes.Queryrinkeby_routerArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_routers: InContextSdkMethod<
    ConnextRinkebyTypes.Query["rinkeby_routers"],
    ConnextRinkebyTypes.Queryrinkeby_routersArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_transfer: InContextSdkMethod<
    ConnextRinkebyTypes.Query["rinkeby_transfer"],
    ConnextRinkebyTypes.Queryrinkeby_transferArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_transfers: InContextSdkMethod<
    ConnextRinkebyTypes.Query["rinkeby_transfers"],
    ConnextRinkebyTypes.Queryrinkeby_transfersArgs,
    MeshContext
  >;
  /** Access to subgraph metadata **/
  rinkeby__meta: InContextSdkMethod<
    ConnextRinkebyTypes.Query["rinkeby__meta"],
    ConnextRinkebyTypes.Queryrinkeby__metaArgs,
    MeshContext
  >;
};
...
export type SubscriptionConnextRinkebySdk = {
  /** null **/
  rinkeby_asset: InContextSdkMethod<
    ConnextRinkebyTypes.Subscription["rinkeby_asset"],
    ConnextRinkebyTypes.Subscriptionrinkeby_assetArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_assets: InContextSdkMethod<
    ConnextRinkebyTypes.Subscription["rinkeby_assets"],
    ConnextRinkebyTypes.Subscriptionrinkeby_assetsArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_assetBalance: InContextSdkMethod<
    ConnextRinkebyTypes.Subscription["rinkeby_assetBalance"],
    ConnextRinkebyTypes.Subscriptionrinkeby_assetBalanceArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_assetBalances: InContextSdkMethod<
    ConnextRinkebyTypes.Subscription["rinkeby_assetBalances"],
    ConnextRinkebyTypes.Subscriptionrinkeby_assetBalancesArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_router: InContextSdkMethod<
    ConnextRinkebyTypes.Subscription["rinkeby_router"],
    ConnextRinkebyTypes.Subscriptionrinkeby_routerArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_routers: InContextSdkMethod<
    ConnextRinkebyTypes.Subscription["rinkeby_routers"],
    ConnextRinkebyTypes.Subscriptionrinkeby_routersArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_transfer: InContextSdkMethod<
    ConnextRinkebyTypes.Subscription["rinkeby_transfer"],
    ConnextRinkebyTypes.Subscriptionrinkeby_transferArgs,
    MeshContext
  >;
  /** null **/
  rinkeby_transfers: InContextSdkMethod<
    ConnextRinkebyTypes.Subscription["rinkeby_transfers"],
    ConnextRinkebyTypes.Subscriptionrinkeby_transfersArgs,
    MeshContext
  >;
  /** Access to subgraph metadata **/
  rinkeby__meta: InContextSdkMethod<
    ConnextRinkebyTypes.Subscription["rinkeby__meta"],
    ConnextRinkebyTypes.Subscriptionrinkeby__metaArgs,
    MeshContext
  >;
};
...
export type ConnextKovanContext = {
  ["Connext_Kovan"]: {
    Query: QueryConnextKovanSdk;
    Mutation: MutationConnextKovanSdk;
    Subscription: SubscriptionConnextKovanSdk;
  };
};

export type ConnextRinkebyContext = {
  ["Connext_Rinkeby"]: {
    Query: QueryConnextRinkebySdk;
    Mutation: MutationConnextRinkebySdk;
    Subscription: SubscriptionConnextRinkebySdk;
  };
};
...
import ExternalModule_4 from "./sources/Connext_Kovan/introspectionSchema";
import ExternalModule_5 from "./sources/Connext_Rinkeby/introspectionSchema";
...
export type Requester<C = {}> = <R, V>(doc: any, vars?: V, options?: C) => Promise<R>;
