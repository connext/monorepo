...
# MNEMONIC="candy maple cake sugar pudding cream honey rich smooth crumble sweet treat" ENV=production CHAIN_ID=1338 ETH_PROVIDER_URL=http://localhost:8547 yarn workspace @connext/contracts hardhat deploy --network local_1337 --tags local
MNEMONIC=${DEFAULT_MNEMONIC} ENV=production CHAIN_ID=1337 ETH_PROVIDER_URL=http://${LOCALHOST}:8547 yarn workspace @connext/contracts hardhat deploy --network local_1337 --tags local
echo "Deployed contracts to 1337"

echo "Deploying contracts to 1338..."
# MNEMONIC="candy maple cake sugar pudding cream honey rich smooth crumble sweet treat" ENV=production CHAIN_ID=1338 ETH_PROVIDER_URL=http://localhost:8546 yarn workspace @connext/contracts hardhat deploy --network local_1338 --tags local
MNEMONIC=${DEFAULT_MNEMONIC} ENV=production CHAIN_ID=1338 ETH_PROVIDER_URL=http://${LOCALHOST}:8546 yarn workspace @connext/contracts hardhat deploy --network local_1338 --tags local
