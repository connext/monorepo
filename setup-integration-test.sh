...
CHAIN_ID=1337 ETH_PROVIDER_URL=http://127.0.0.1:8545 yarn workspace @connext/nxtp-contracts hardhat deploy --network local_1337
echo "Deployed contracts to 1337"

echo "Deploying contracts to 1338..."
CHAIN_ID=1338 ETH_PROVIDER_URL=http://127.0.0.1:8546 yarn workspace @connext/nxtp-contracts hardhat deploy --network local_1338
