...
# [sudo] bash docker/sequencer/build-integration.sh

app_full_name=@connext/nxtp-sequencer
app_name=nxtp-sequencer
# remove scope like "@my-org/", if any.
short_app_dir=sequencer # i.e. packages/router to /router
